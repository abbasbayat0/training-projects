    ...
    <div className={`h-screen w-full ${dark && 'bg-gray-800'} transition duration-500`}>
      <div className={`mx-auto flex max-w-7xl items-center justify-center transition duration-500`}>
        ...
        >
          ...
          <button
            className={`mt-3 flex w-full cursor-pointer items-center justify-center rounded-md bg-blue-800 px-4 py-3 text-white opacity-80 select-none hover:shadow ${dark && 'bg-blue-500'} transition duration-500`}
          >
            GUEST USER
          </button>
